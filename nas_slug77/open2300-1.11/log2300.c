 ...
 *
 * Log file format:
 * Timestamp Date Time Ti To DP RHi RHo Wind Dir-degree Dir-text gust WC
...
int main(int argc, char *argv[])
{
	...
	/* READ WIND GUST - miles/hour */

		if (GUST)
		{
			//tmpvalue = wind_minmax(ws2300, MILES_PER_HOUR, NULL, NULL, NULL, NULL);
			//if (tmpvalue>100.0) tmpvalue=0.0;
			sprintf(tempstring, "%.2f ",wind_minmax(ws2300, MILES_PER_HOUR, NULL, NULL, NULL, NULL));
			strcat(logline, tempstring);
